...
from keras_cv.models.object_detection.yolo_v8_quantized.yolo_v8_iou_loss_quantized import (
    YOLOV8IoULossQuantized,
)
from keras_cv.models.object_detection.yolo_v8_quantized.yolo_v8_label_encoder_quantized import (
    YOLOV8LabelEncoderQuantized,
)
from keras_cv.models.object_detection.yolo_v8_quantized.yolo_v8_layers_quantized import (
    apply_conv_bn,
)
from keras_cv.models.object_detection.yolo_v8_quantized.yolo_v8_layers_quantized import (
    apply_csp_block,
...
class YOLOV8DetectorQuantized(Task):
