...
echo "Running python script to generate matrices"
srun python3 generate_matrices.py

echo "Running python script to generate labels"
srun python3 generate_labels.py